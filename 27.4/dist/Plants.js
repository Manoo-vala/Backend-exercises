...
var Plants = /** @class */ (function () {
    ...
    Plants.prototype.initPlant = function (plant) {
    ...
    Plants.prototype.getPlants = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile('plants.json', { encoding: 'utf8' })];
                    case 1:
                        plantsRaw = _a.sent();
    ...
    Plants.prototype.getPlantById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var plantsRaw, plants, plantById;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile('plants.json', { encoding: 'utf8' })];
                    case 1:
    ...
    Plants.prototype.removePlantById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var plantsRaw, plants, removedPlant, newPlants;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile('plants.json', { encoding: 'utf8' })];
                    case 1:
                        ...
                        return [4 /*yield*/, promises_1.default.writeFile('plants.json', JSON.stringify(newPlants))];
                    case 2:
                        _a.sent();
    ...
    Plants.prototype.getPlantsThatNeedsSunWithId = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var plantsRaw, plants, filteredPlants;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile('plants.json', { encoding: 'utf8' })];
                    case 1:
    ...
    Plants.prototype.editPlant = function (plantId, newPlant) {
        return __awaiter(this, void 0, void 0, function () {
            var plantsRaw, plants, updatedPlants;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile('plants.json', { encoding: 'utf8' })];
                    case 1:
                        ...
                        return [4 /*yield*/, promises_1.default.writeFile('plants.json', JSON.stringify(updatedPlants))];
                    case 2:
                        _a.sent();
    ...
    Plants.prototype.savePlant = function (plant) {
        return __awaiter(this, void 0, void 0, function () {
            var plantsRaw, plants, newPlant, opsInfoRaw, createdPlants;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile('plants.json', { encoding: 'utf8' })];
                    case 1:
                        plantsRaw = _a.sent();
                        plants = JSON.parse(plantsRaw);
                        newPlant = this.initPlant(__assign({}, plant));
                        plants.push(newPlant);
                        return [4 /*yield*/, promises_1.default.readFile('opsInfo.json', { encoding: 'utf8' })];
                    case 2:
                        opsInfoRaw = _a.sent();
                        createdPlants = JSON.parse(opsInfoRaw).createdPlants;
                        createdPlants += 1;
                        return [4 /*yield*/, promises_1.default.writeFile('opsInfo.json', JSON.stringify({ createdPlants: createdPlants }))];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, promises_1.default.writeFile('plants.json', JSON.stringify(plants))];
                    case 4:
                        _a.sent();
                        return [2 /*return*/, newPlant];
                }
